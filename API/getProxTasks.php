...
$sql = "SELECT t.id_t, t.tarea, t.fecha_programada, p.nombre_comun FROM Tareas t JOIN plantas p ON t.id_planta = p.id WHERE p.usuario_id = ? ORDER BY fecha_programada ASC";
